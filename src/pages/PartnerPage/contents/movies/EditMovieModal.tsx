    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      >
        <div className="sticky top-0 bg-slate-800 border-b border-slate-700 p-6 flex justify-between items-center">
          <h3 className="text-2xl font-bold text-white">Edit Movie: {selectedMovie.title}</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleUpdateMovie} className="p-6 space-y-6">
          {/* Error Messages */}
          {formErrors.length > 0 && (
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div
                    ...
                    onClick={() => document.getElementById('trailer-upload-edit')?.click()}
                  >
                    <input
                      id="trailer-upload-edit"
                      type="file"
                      accept="video/*"
                  ...
                  {(trailerPreview || formData.trailer_url) && (
                    <div className="relative">
                      <video
                        src={trailerPreview || formData.trailer_url}
                        className="w-full h-32 object-cover rounded-lg"
                        controls
                      />
                      <button
