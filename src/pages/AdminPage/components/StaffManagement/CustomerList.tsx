  ...
  return (
    ...
    >
      ...
      <div className="px-6 py-4 bg-gradient-to-r from-slate-700/80 to-slate-800/80 border-b border-slate-700/50 flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-white">Customers Available for Promotion</h3>
          <p className="text-sm text-gray-400">Select a customer to promote to staff</p>
        </div>
        <motion.button
          onClick={onRefresh}
        ...
        {customers.length === 0 ? (
          <div className="text-center py-12">
            <div className="text-gray-400 mb-4">
              ...
              <p className="text-lg">No customers available for promotion</p>
              <p className="text-sm">All customers have been promoted or there are no customers in the system.</p>
            </div>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-3 flex-1">
                    <h4 className="text-white font-medium">{customer.name || 'No name'}</h4>
