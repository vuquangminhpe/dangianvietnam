...
const AdvancedSearchPage = () => {
  ...
  const handleSearch = async (params?: AdvancedSearchParams, resetPage = true) => {
    const searchData = params || searchParams;
    
    if (!searchData.q && !searchData.genre && !searchData.year && !searchData.language) {
      setMovies([]);
      return;
    }
  ...
  const genres = ["Action", "Comedy", "Drama", "Horror", "Thriller", "Romance", "Sci-Fi", "Fantasy", "Animation", "Adventure"];
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            Find the perfect movie with our powerful search filters
          </p>
        </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSearchParam("year", e.target.value ? parseInt(e.target.value) : undefined)}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:border-orange-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSearchParam("duration_min", e.target.value ? parseInt(e.target.value) : undefined)}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:border-orange-500"
                    placeholder="e.g. 90"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSearchParam("duration_max", e.target.value ? parseInt(e.target.value) : undefined)}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:border-orange-500"
                    placeholder="e.g. 180"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSearchParam("rating_min", e.target.value ? parseFloat(e.target.value) : undefined)}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:border-orange-500"
                    placeholder="e.g. 7.0"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSearchParam("rating_max", e.target.value ? parseFloat(e.target.value) : undefined)}
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:border-orange-500"
          ...
          >
            ...
            {currentPage < totalPages && (
              <div className="flex justify-center mt-12">
                ...
                >
                  {loading ? "Loading..." : `Load More (${movies.length}/${totalResults})`}
                </button>
              </div>
            )}
          </motion.div>
        ...
        {!loading && movies.length === 0 && (searchParams.q || searchParams.genre || searchParams.year) && (
          <motion.div
            initial="hidden"
            animate="visible"
            variants={fadeUp}
        ...
        {!searchParams.q && !searchParams.genre && !searchParams.year && !searchParams.language && movies.length === 0 && !loading && (
          <motion.div
            initial="hidden"
            animate="visible"
            variants={fadeUp}
          ...
          >
            ...
            <p className="text-gray-400 text-lg">
              Use the search form above to find movies that match your preferences.
            </p>
          </motion.div>
        )}
      </div>
